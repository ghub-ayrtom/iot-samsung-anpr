import sys
sys.path.insert(1, '/home/ayrtom/PycharmProjects/IoT_Samsung_ANPR/models/LPRNet')
...
def get_prediction(image_bytes, debug=False):
    ...
    license_plate_detections = license_plate_detection_model(license_plate_image)[0]
    ...
    for license_plate in license_plate_detections.boxes.data.tolist():
        ...
        if debug:
            cv2.rectangle(license_plate_image, (int(x1), int(y1)), (int(x2), int(y2)), (255, 0, 0), 5)
    ...
    return 'The license plate was not recognized.'
